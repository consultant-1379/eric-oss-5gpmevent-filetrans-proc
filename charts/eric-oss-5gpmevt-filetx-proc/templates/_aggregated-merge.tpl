...
*/ -}}
{{- define "eric-oss-5gpmevt-filetx-proc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-5gpmevt-filetx-proc.mergeAnnotations" -}}
  {{- include "eric-oss-5gpmevt-filetx-proc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-5gpmevt-filetx-proc.mergeLabels" -}}
  {{- include "eric-oss-5gpmevt-filetx-proc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
